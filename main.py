...
ai_client = client.Client(api_key=GEMINI_API_KEY)
...
if stderr:
prompt = f"Eres un profesor de Python. Analiza este codigo: {req.codigo} y este
error: {stderr}. Indica el numero de linea exacto y la explicacion."
ai_res = ai_client.models.generate_content(
model="gemini-2.5-flash",
contents=prompt
)
return {"exito": False, "salida": output, "error": stderr, "explicacion_ia":
ai_res.text}
